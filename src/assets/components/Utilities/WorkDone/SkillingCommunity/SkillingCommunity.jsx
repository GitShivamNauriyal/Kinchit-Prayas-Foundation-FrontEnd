...
import SkillingCommunityImage1 from "../../../../../assets/images/skillingCommunity/skill1.jpg";
import SkillingCommunityImage2 from "../../../../../assets/images/skillingCommunity/skill2.jpg";
import SkillingCommunityImage3 from "../../../../../assets/images/skillingCommunity/skill6.jpg";
import SkillingCommunityImage4 from "../../../../../assets/images/skillingCommunity/skill3.jpg";
import SkillingCommunityImage11 from "../../../../../assets/images/skillingCommunity/skill4.jpg";
import SkillingCommunityImage5 from "../../../../../assets/images/skillingCommunity/skill7.jpg";
import SkillingCommunityImage6 from "../../../../../assets/images/skillingCommunity/skill8.jpg";
import SkillingCommunityImage7 from "../../../../../assets/images/skillingCommunity/skill9.jpg";
import SkillingCommunityImage8 from "../../../../../assets/images/skillingCommunity/skill10.jpg";
import SkillingCommunityImage9 from "../../../../../assets/images/skillingCommunity/skill11.jpg";
import SkillingCommunityImage10 from "../../../../../assets/images/skillingCommunity/skill12.jpg";
        ...
        <div className="SkillingCommunity-PageMaster">
            ...
            <div className="content1 grid-section-column">
                <div className=" Content1-col1">
                    <div id="Content1-image1" className="Content1-image">
                        <img loading="lazy" src={SkillingCommunityImage1} alt="not loaded" />
                    </div>
                    <div id="Content1-image2" className="Content1-image">
                        <img loading="lazy" src={SkillingCommunityImage2} alt="not loaded" />
                    </div>
                    <div id="Content1-image3" className="Content1-image">
                        <img loading="lazy" src={SkillingCommunityImage3} alt="not loaded" />
                    </div>
                </div>
            ...
            <div className="content2 grid-section-column">
                ...
                <div className="content2-col2">
                    <img loading="lazy" src={SkillingCommunityImage4} alt="not loaded" />
                </div>
            </div>
            ...
            <div className="Skilling-Community-Affilation">
                <div className="Skilling-Community-Affilation-grid-content SC-Aff_1">
                    <div className="SC-Aff-img-container">
                        <img loading="lazy" src={Logo1} alt="Affiliation Logo" />
                    </div>
                </div>
                <div className="Skilling-Community-Affilation-grid-content SC-Aff_2">
                    <div className="SC-Aff-img-container">
                        <img loading="lazy" src={Logo2} alt="Affiliation Logo" />
                    </div>
                </div>
                <div className="Skilling-Community-Affilation-grid-content SC-Aff_3">
                    <div className="SC-Aff-img-container">
                        <img loading="lazy" src={Logo3} alt="Affiliation Logo" />
                    </div>
                </div>
            </div>
